...
public class SpawnerFactory {
    ...
    private void loadSpawners() {
        for (String path : spawnerConfig.getConfig().getConfigurationSection("spawners").getKeys(false)) {
            ...
            // Load drops
            boolean enableDrops = section.getBoolean("drops.enable");
            ...
            System.out.println("Loaded spawner: " + path + " with type " + type + ", minDelay " + minDelay + ", maxDelay " + maxDelay +
                    ", spawnCount " + spawnCount + ", spawnRange " + spawnRange + ", drops " + drops.size());
